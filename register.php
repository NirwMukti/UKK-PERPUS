                        ...
                        <div class="p-5">
                            ...
                            <?php
                                if(isset($_POST['register'])) {
                                    ...
                                    $insert = mysqli_query($koneksi, "INSERT INTO user(nama,username,password,email,alamat,no_telepon, level) VALUES('$nama','$username','$password','$email','$alamat', '$no_telp','$level')");

                                    if($insert){
                                        echo '<script>alert("Selamat, register berhasil. Silahkan Login"); location.href="login.php"</script>';
                                    } else 
                                        echo '<script>alert("Maaf Register Gagal. Mohon Ulangi Lagi")</script>';
                                }
                            ?>
                            <form method="post" class="user">
                                ...
                                <div class="form-group">
                                    <input type="tel" class="form-control form-control-user" name="no_telepon"
