...
<div class="row">
    <a href="?page=peminjaman_tambah" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mb-4"><i
            class="fa fa-plus text-white-50"></i> Tambah Peminjaman</a>
